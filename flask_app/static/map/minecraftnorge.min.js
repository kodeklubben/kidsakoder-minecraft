...
var dataDist = function () {
    function a(a) {
        ...
        var b = a.serviceResponse.statusInfo.status, c = "", d = $("<div />");
        "success" == b ? (c = a.serviceResponse.url, d.append($("<p>Vellykket</p>")), d.append($('<a href="' + c + '">Last ned! </a>'))) : d.append($("<p>Mislykket. Prøv igjen!</p>")), $("#results").html(d), $("#resultpanel").css("visibility", "visible"), $("#resultpanel").css("height", "auto"), $("#resultpanel").css("width", "auto")
    }
...
$("#helpmodal").modal("hide"), $.fn.bootstrapSwitch.defaults.onColor = "default", $.fn.bootstrapSwitch.defaults.onText = "På", $.fn.bootstrapSwitch.defaults.offText = "Av", $.fn.bootstrapSwitch.defaults.labelWidth = "55px", $("[name='texted_world']").bootstrapSwitch(), $(".bootstrap-switch-label").css({
    "font-size": "10px",
    "line-height": "10px",
    height: "32px",
    "margin-top": "-3px",
...
}), $(".bootstrap-switch-container").css({width: "174px"}), $("#submit").attr("disabled", !0), $("#world_name").on("keyup", function () {
